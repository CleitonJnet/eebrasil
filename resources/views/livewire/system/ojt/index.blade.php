<div class="grid grid-cols-12 gap-4">
    <div class="col-span-2">
        <div class="grid gap-1 mb-4">
            <button type="button" class="flex items-center justify-start h-10 px-2 rounded-sm bg-sky-600 text-sky-50">
                ...
                <span class="ml-2">Cadastrar nova visita</span>
            </button>
        </div>
    </div>
