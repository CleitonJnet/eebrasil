...
class Edit extends Component
{
    ...
    public function mount(Training $event){
        $this->user         = Auth()->user();
        $this->event        = $event;
        $this->church_id    = $this->event->church_id;
        $this->course       = $this->event->course_id;
        $this->teacher      = $this->event->user->id;
        $this->date         = $this->event->date;
        $this->url          = $this->event->url;
        $this->phone        = $this->event->phone;
        $this->email        = $this->event->email;
        ...
        $this->neighborhood = $this->event->neighborhood;
        $this->city         = $this->event->city;
        $this->status       = $this->event->status;
        $this->kits         = $this->event->kits;
        $this->price        = $this->event->price;
        $this->price_church = $this->event->price_church;
        $this->discount     = $this->event->discount;
        $this->zone         = $this->event->zone_id;
        $this->comment      = $this->event->comment;
        $this->lesonplan    = $this->event->available_id;
    }
    ...
    public function update()
    {
        $this->event->update([
            ...
            'church_id'         => isset($this->church_selected->id)?$this->church_selected->id:$this->church_id,
            'url'               => $this->url,
            'date'              => $this->date,
    ...
    public function render()
    {
        ...
        return view('livewire.system.event.edit',[ 'churches' => Church::query()->when($this->search_church, fn($q) => $q->where('name','like','%'.$this->search_church.'%'))->orderBy('name')->paginate(5) ]);
    }
}
